...
urlpatterns = [
    ...
    path('api/call/', include('HumeAiTwilio.urls_call')),  # Call initiation with agent selection
    
    # Agent Training APIs
    path('api/agent/', include('HumeAiTwilio.urls_training')),  # Continuous learning APIs
